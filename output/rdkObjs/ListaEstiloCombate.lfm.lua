...
local function constructNew_frmListaEstiloCombate()
    ...
    obj:beginUpdate();
    obj:setName("frmListaEstiloCombate");
    obj:setHeight(50);
    obj:setTheme("dark");
    ...
    obj.label1:setField("NomeEDCFinal");
...
function newfrmListaEstiloCombate()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmListaEstiloCombate();
      end,
      function()
...
local _frmListaEstiloCombate = {
    newEditor = newfrmListaEstiloCombate, 
    new = newfrmListaEstiloCombate, 
    name = "frmListaEstiloCombate", 
    dataType = "", 
    formType = "undefined", 
...
frmListaEstiloCombate = _frmListaEstiloCombate;
Firecast.registrarForm(_frmListaEstiloCombate);

return _frmListaEstiloCombate;
