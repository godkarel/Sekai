...
local function constructNew_frmKutchyoseFicha()
    ...
    obj.button1:setWidth(140);
    obj.button1:setHeight(40);
    obj.button1:setText("Novo Jutsu Kutchyose");
    ...
    obj.button2:setLeft(445);
    obj.button2:setTop(120);
    obj.button2:setFontSize(20);
    obj.button2:setOpacity(0.0);
    obj.button2:setHeight(120);
    ...
    obj._e_event1 = obj.rclListaJutsusKutchyose:addEventListener("onSelect",
        function (_)
            --[[
